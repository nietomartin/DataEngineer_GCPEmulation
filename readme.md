...
El ejercicio utiliza herramientas emuladoras de este sistema presentando un pipeline con cuatro archivos de 250 Mg para un total de una carga de 1Gb, utilizando una arquitectura Medaliion y finalmente presentando una API con un microservicio con un reporte Json.
...
O ejecución de ls scripts python :
